<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-yellow-100">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        ...
        >
          ...
          <li>
            <g-link to="/Lessons" class="text-copy-primary hover:text-gray-600">Lessons</g-link>
          </li>
        </ul>
      </nav>
    </header>
    ...
    <footer class="bg-yellow-200 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          <li class="mr-8">
            <a href="https://www.facebook.com/leah.richards.148" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://www.youtube.com/channel/UCjjFzr1Tt94ea0ktlrU88EQ" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://www.instagram.com/leeee_ez/" target="_blank" class="text-white hover:text-gray-400">
